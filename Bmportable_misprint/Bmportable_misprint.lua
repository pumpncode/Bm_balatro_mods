...
function G.UIDEF.current_stake()
    ...
    local t = {n=G.UIT.ROOT, config={align = "cm", colour = G.C.CLEAR}, nodes={
        ...
        next(G.GAME.history_hands) and {n=G.UIT.R, config={align = "cm", padding = 0.04}, nodes={
            create_UIBox_history_hand_row(G.GAME.history_hands[#G.GAME.history_hands]),
            G.GAME.history_hands[#G.GAME.history_hands-1] and create_UIBox_history_hand_row(G.GAME.history_hands[#G.GAME.history_hands-1]) or nil,
            G.GAME.history_hands[#G.GAME.history_hands-2] and create_UIBox_history_hand_row(G.GAME.history_hands[#G.GAME.history_hands-2]) or nil,
            G.GAME.history_hands[#G.GAME.history_hands-3] and create_UIBox_history_hand_row(G.GAME.history_hands[#G.GAME.history_hands-3]) or nil
        }}
    }}
    return t
end
