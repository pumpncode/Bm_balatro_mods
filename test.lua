return {
    ...
    misc={
        ...
        dictionary={
            ...
            k_tarot="Tarot",
            k_trophies_disabled="Achieve",
            k_trophy="Select an Achievement",
            k_uncommon="Uncommon",
            ...
            ph_alert_debuff_confirm="Subscribe",
            ...
            ph_demo_thanks_1="Quick Load",
            ph_demo_thanks_2="Manual Tags",
